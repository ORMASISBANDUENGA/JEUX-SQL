...
import { User, Shield, Volume2, VolumeX, RotateCcw, Award, Check, Sparkles, Sun, Moon, Globe, Download, PlayCircle, MessageCircle, Smartphone, Monitor } from 'lucide-react';
      ...
      <div className="bg-gradient-to-r from-[#12163b] via-[#101433] to-[#12163b] border border-[#2c377a] rounded-3xl p-6 space-y-4 shadow-xl">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <button
            ...
            className="w-full sm:w-auto px-6 py-3 rounded-2xl bg-gradient-to-r from-emerald-500 to-[#00D4FF] hover:brightness-110 text-white font-extrabold text-xs flex items-center justify-center gap-2 shadow-lg transition-transform active:scale-95"
          >
