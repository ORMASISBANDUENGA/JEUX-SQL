...
import { Download, Monitor, Smartphone, Apple, Check, X, Sparkles, ExternalLink, Zap, Shield } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="overflow-y-auto py-4 space-y-4 pr-1">
          ...
          {/* Quick Native Install Button (if browser supports standard beforeinstallprompt) */}
          <div className="p-4 rounded-2xl bg-gradient-to-r from-[#171c45] to-[#121636] border border-[#3b458c] flex flex-col sm:flex-row items-center justify-between gap-3">
            <div className="flex items-center gap-3 text-left">
              ...
              <div>
                <h4 className="text-xs font-bold text-white">Installation 1-Clic Rapide</h4>
                <p className="text-[11px] text-slate-400">Fonctionne sur Chrome, Edge, Brave, Android & PC</p>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full sm:w-auto px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#6C63FF] via-[#00D4FF] to-[#00E676] hover:brightness-110 text-white font-extrabold text-xs flex items-center justify-center gap-2 shadow-lg transition-transform active:scale-95 whitespace-nowrap"
            >
